...
/**
 * MainLayout theme-aware — thay thế src/components/layout/MainLayout.tsx.
 * - layout "sidebar" (classic, moss): Sidebar + Topbar như hiện tại.
 * - layout "topnav" (terracotta): TopNav ngang; Sidebar chỉ còn là drawer mobile.
 * - Mobile (<lg): thêm BottomTabBar cho mọi theme; nội dung chừa pb-16.
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-zinc-50 relative selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main className="min-h-0 flex-1 overflow-y-auto custom-scrollbar pb-16 lg:pb-0">
          <Outlet />
        </main>
      </div>
      <BottomTabBar />
