...
create index if not exists inventory_adjustment_requests_status_idx on public.inventory_adjustment_requests(status, created_at desc);
create index if not exists inventory_edit_logs_product_idx on public.inventory_edit_logs(product_id, created_at desc);
create index if not exists price_update_requests_status_idx on public.price_update_requests(status, created_at desc);
create index if not exists price_update_request_items_request_idx on public.price_update_request_items(request_id);
create index if not exists price_edit_logs_product_idx on public.price_edit_logs(product_id, created_at desc);
