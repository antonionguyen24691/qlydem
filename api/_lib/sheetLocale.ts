// Bản đồ Việt hóa Google Sheets: tên bảng (Supabase) -> tên tab tiếng Việt,
// và tên cột -> nhãn tiếng Việt. Dùng chung cho api/_lib/googleSheets.ts,
// scripts/pmql-sheet-locale.mjs và scripts/google-apps-script/PMQL_MasterScript.gs.
// ⚠️ Giữ 3 nơi ĐỒNG NHẤT nếu chỉnh sửa.

export const SHEET_NAME_VI: Record<string, string> = {
  dashboard: "Tổng quan",
...
export const COLUMN_LABEL_VI: Record<string, string> = {
  id: "ID",
  code: "Mã",
  name: "Tên",
  short_name: "Tên ngắn",
  ...
  parent_product_id: "SP cha",
  category: "Danh mục",
  brand: "Thương hiệu",
  size: "Kích thước",
  unit: "ĐVT",
  m2_per_box: "M2/hộp",
  pieces_per_box: "Viên/hộp",
  price_by_m2: "Giá theo M2",
  sell_price_box_vat: "Giá hộp VAT",
  cost_price: "Giá vốn",
  vat_rate: "VAT %",
  barcode: "Barcode",
  track_lots: "Quản lý lô",
  warehouse_id: "Kho",
  product_id: "Sản phẩm",
  quantity_box: "SL hộp",
  quantity_piece: "SL lẻ",
  min_stock_level: "Tồn tối thiểu",
  lot_id: "Lô",
  lot_code: "Số lô",
  supplier_id: "Nhà cung cấp",
  purchase_id: "Đơn nhập",
  received_date: "Ngày nhập",
  unit_cost: "Giá vốn",
  color_note: "Màu/mẻ",
  quality_note: "Chất lượng",
  image_urls: "Ảnh",
  order_id: "Đơn hàng",
  order_date: "Ngày đơn",
  ...
  printed_at: "Ngày in",
  returned_amount: "Đã trả hàng",
  product_code: "Mã hàng",
  quantity: "Số lượng",
  unit_price: "Đơn giá",
  line_total: "Thành tiền",
  unit_cost_snapshot: "Giá vốn ghi nhận",
  ...
  due_date: "Hạn",
  original_amount: "Số gốc",
  remaining_amount: "Còn lại",
  assigned_to: "Phụ trách",
  last_reminded_at: "Nhắc gần nhất",
  next_reminder_at: "Nhắc kế tiếp",
  closed_at: "Ngày đóng",
  receipt_id: "Phiếu thu",
  order_debt_id: "Công nợ đơn",
  allocated_at: "Ngày phân bổ",
  allocated_by: "Người phân bổ",
  reminder_type: "Loại nhắc",
  channel: "Kênh",
  scheduled_at: "Lịch nhắc",
  title: "Tiêu đề",
  message: "Nội dung",
  reminder_id: "Nhắc nợ",
  sent_at: "Ngày gửi",
  recipient: "Người nhận",
  response_json: "Phản hồi",
  promised_amount: "Số hẹn",
  promised_date: "Ngày hẹn",
  role: "Vai trò",
  quantity_change: "Thay đổi SL",
  stock_after: "Tồn sau",
  ...
  old_quantity_box: "SL cũ",
  new_quantity_box: "SL mới",
  old_sell_price: "Giá bán cũ",
  new_sell_price: "Giá bán mới",
  old_cost_price: "Giá vốn cũ",
  edited_by: "Người sửa",
  account_type: "Loại tài khoản",
  direction: "Chiều",
  refund_method: "Cách hoàn",
  reason_code: "Mã lý do",
  reason: "Lý do",
  condition: "Tình trạng",
  refund_cash_amount: "Hoàn tiền mặt",
  debt_offset_amount: "Cấn nợ",
  credit_amount: "Vào số dư",
  entity_type: "Loại đối tượng",
  file_name: "Tên file",
  total_rows: "Tổng dòng",
  success_rows: "Dòng thành công",
  failed_rows: "Dòng lỗi",
  completed_at: "Hoàn tất lúc",
  batch_id: "Lô import",
  row_number: "Dòng",
  row_json: "Dữ liệu dòng",
  error_message: "Lỗi",
  action: "Hành động",
...
export function sheetNameVi(table: string): string {
  return SHEET_NAME_VI[table] ?? table;
}

export function columnLabelVi(key: string): string {
